...
let other = new Weight(10, { units: "Kg" });

console.log(other.inMg());
console.log(other.inMg(true));

console.log(other.inKg());
console.log(other.inKg(true));

// Add 20 grams and subrtract a kilo before formating in Kg.
console.log(other.addGrams(20).addKg(-1).inKg(true));
